...
def generate_analysis_pdf(user_list, file_name):
    ...
    REFERENCE_NOTES = [("MI", 2), ("DO", 2), ("MI", 1), ("MI", 1), ("DO", 2),
                       ("RÉ", 1), ("MI", 1), ("FA", 1), ("MI", 1), ("RÉ", 1),
                       ("SOL", 1), ("MI", 2), ("DO", 2), ("MI", 2), ("DO", 2),
                       ("MI", 1), ("MI", 1), ("DO", 2), ("RÉ", 1), ("MI", 1),
                       ("FA", 1), ("MI", 1), ("RÉ", 1), ("SOL", 1), ("DO", 4)]
    NOTE_FREQUENCIES = {
    ...
    for i in range(n):
        ref_note, ref_dur = REFERENCE_NOTES[i]
        user_freq, user_dur = user_list[i]
        
        user_note = NOTE_FREQUENCIES.get(user_freq, f"{user_freq} Hz")
        
        if ref_note != user_note:
            justesse_errors.append((i+1, ref_note, user_note))
        if abs(ref_dur - user_dur) > 0.2:
            tempo_errors.append((i+1, ref_dur, user_dur))
    
    # Scores
    justesse_score = max(0, 100 - (len(justesse_errors) * 5))
    tempo_score = max(0, 100 - (len(tempo_errors) * 5))
...
def generate_analysis_pdf_2(user_list, file_name):
    ...
    # Référence des notes attendues
    REFERENCE_NOTES = [("DO", 0.5), ("DO", 0.5), ("DO", 1.0), ("RÉ", 0.5), ("RÉ", 0.5), ("RÉ", 1.0),
              ("MI", 0.5), ("FA", 0.5), ("SOL", 0.5), ("DO", 0.5), ("SI", 0.5), ("DO", 0.5),
              ("RÉ", 0.5), ("SOL", 0.5), ("DO", 0.5), ("DO", 0.5), ("DO", 1.0), ("RÉ", 0.5),
              ("RÉ", 0.5), ("RÉ", 1.0), ("MI", 0.5), ("FA", 0.5), ("SOL", 0.5), ("DO", 0.5),
              ("RÉ", 0.5), ("SI", 0.5), ("DO", 3.0)]
